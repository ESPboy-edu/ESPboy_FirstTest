...
//LCD TFT init
  ...
  bus = new Arduino_ESP8266SPI(TFT_DC, TFT_CS);
  tft = new Arduino_ST7735(bus, TFT_RST, 0 /* rotation */, false /* IPS */, 128 /* width */, 128 /* height */, 2 /* col offset 1 */, 3 /* row offset 1 */, 2 /* col offset 2 */, 1 /* row offset 2 */);
  tft->begin();
...
//draw ESPboylogo  
  ...
  tft->setCursor ((128-(strlen(appName)*6))/2, 102);
  tft->print (appName);
